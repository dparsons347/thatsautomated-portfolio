...
|---|---|---|---|---|---|
| 1 | known | What are your hours on Saturday | ANSWER from hours rule | | |
...
| 12 | second phone | Do you install solar panels (after the owner answered #6 as reusable) | ANSWER from the new human-sourced rule | | |
...
- **Unknown question:** #6. Show `model_raw` with `"decision": "ESCALATE"` and the reason, the holding text on the phone, the row on the Interfaces queue page.
